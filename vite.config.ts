      ...
      \`;
        ...
        <div class="card" style="margin-top:14px">
          ...
          <ul style="margin:10px 0 0;padding-left:18px;line-height:1.55;color:#c9d4e6;font-size:13px">
            <li>만화 컷 설명을 cut 1 is scene. 설명 형식으로 표시하며, close-up·upperbody 컷 종류도 명시합니다.</li>
          </ul>
        </div>
        <div class="card" style="margin-top:14px">
          <strong>0.2.9</strong>
        ...
        <div class="card" style="margin-top:14px">
          <strong>0.2.8</strong>
          <ul style="margin:10px 0 0;padding-left:18px;line-height:1.55;color:#c9d4e6;font-size:13px">
            <li>화면 갱신 뒤 스크롤 이벤트 해제에 사용하던 옵션을 맞춰, 반복해서 열고 닫을 때 이벤트와 메모리가 누적되던 문제를 고쳤습니다.</li>
          </ul>
        </div>
        <div class="card" style="margin-top:14px">
          <strong>0.2.7</strong>
        ...
        <div class="card" style="margin-top:14px">
          <strong>0.2.5</strong>
          <ul style="margin:10px 0 0;padding-left:18px;line-height:1.55;color:#c9d4e6;font-size:13px">
            <li>생성 작업이 끝나면 메모리의 작업 정보와 대기 연결을 정리해 반복 생성에 따라 누적되지 않도록 했습니다.</li>
            <li>이미지 크게보기를 마우스로 닫아도 키보드 이벤트가 남지 않도록 정리하고, 캐릭터 선택 이미지 캐시에 16MB·128개 제한을 적용했습니다.</li>
